...
const RevenueOverview = () => {
  ...
  //       `/vendor/dashboard/stats/${user.email}`
  //     );
  //     return res.data;
  //   },
  //   enabled: !!user?.email,
  ...
  //             Average: ${averageDailyRevenue}/day
  //           </p>
  //         </div>
  //         {/* Tickets Sold */}
  ...
  //             Average:{" "}
  //             {chartData.length
  //               ? (totalTicketsSold / chartData.length).toFixed(1)
  //               : 0}
  //             /day
  //           </p>
  //         </div>
  ...
  //           </p>
  //           <p className="text-xs text-gray-500 mt-2">Total inventory added</p>
  //         </div>
  //         {/* Conversion Rate */}
